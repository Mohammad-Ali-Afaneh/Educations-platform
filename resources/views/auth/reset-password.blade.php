...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-3">
                <label for="verification_code" class="form-label">Verification Code (6 digits)</label>
                <input type="text" class="form-control" id="verification_code" name="verification_code" value="{{ old('verification_code') }}" required maxlength="6">
            </div>
