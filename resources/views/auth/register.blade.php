...
<head>
    ...
    <title>Register - Teachers & Students</title>
    ...
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input type="checkbox" id="reading" name="hobbies[]" value="reading" {{ is_array(old('hobbies')) && in_array('reading', old('hobbies')) ? 'checked' : '' }}>
                    <label class="form-check-label" for="reading">Reading</label>
                </div>
                <div class="form-check form-check-inline">
                    <input type="checkbox" id="sports" name="hobbies[]" value="sports" {{ is_array(old('hobbies')) && in_array('sports', old('hobbies')) ? 'checked' : '' }}>
                    <label class="form-check-label" for="sports">Sports</label>
                </div>
                <div class="form-check form-check-inline">
                    <input type="checkbox" id="music" name="hobbies[]" value="music" {{ is_array(old('hobbies')) && in_array('music', old('hobbies')) ? 'checked' : '' }}>
